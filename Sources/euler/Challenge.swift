    ...
    enum EulerChallenge: Int {
        ...
        func execute() {
            switch self {
                ...
                case .challenge26:
                if solution == true {
                    let challengeSolution: Int = Challenge26().reciprocalCycles(for: inputChallenge26)
                        print("Solution: \(challengeSolution)")
                    } else {
                        print(descriptionForChallenge26)
                }
                case .challenge27:
                if solution == true {
                    let challengeSolution: Int = Challenge27().quadraticPrimes(for: inputChallenge27)
                        print("Solution: \(challengeSolution)")
                    } else {
                        print(descriptionForChallenge27)
                }
                case .challenge28:
                if solution == true {
                    let challengeSolution: Int = Challenge28().spiralDiagonals(number: inputChallenge28)
                        print("Solution: \(challengeSolution)")
                    } else {
                        print(descriptionForChallenge28)
                }
                case .challenge29:
                if solution == true {
                    let challengeSolution: Int = Challenge29().distinctPowers(number: inputChallenge29)
                        print("Solution: \(challengeSolution)")
                    } else {
                        print(descriptionForChallenge29)
                }
                case .challenge30:
                if solution == true {
                    let challengeSolution: Int = Challenge30().digitnPowers(number: inputChallenge30)
                        print("Solution: \(challengeSolution)")
                    } else {
                        print(descriptionForChallenge30)
                }
            }
        }
    }
